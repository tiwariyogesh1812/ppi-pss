 ...
 */
	public function send() {
		...
		$head .= $this->Html->scriptBlock($js);
                ...
                // captcha refresh code written here, yogesh ppi 20150316
                $customizejs = "function getCaptcha() {
                                javascript:location.reload(true);
                            };";                
                $head .= $this->Html->scriptBlock($customizejs);
                // captcha refresh code written above, yogesh ppi
